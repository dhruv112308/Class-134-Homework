...
train_data = pd.read_csv("./static/dataset/updated_product_dataset.csv")    
training_sentences = []
...
model = load_model("./static/model/Text_Emotion.h5")
...
emo_code_url = {
    "Neutral": [0, "./static/emoticons/neutral.png"],
    "Positive": [1,"./static/emoticons/positive.png" ],
    "Negative": [2, "./static/emoticons/negative.png"]
    }
